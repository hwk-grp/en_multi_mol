...
opt = f'../../../feats/gcn_en/en_an_hy_2_2024.xlsx' # from 2021 2030
...
df.to_excel(f'preds/gcn_{dataset_name}_{rand_seed}_at1_2.xlsx', index=False)

# Save the GCN model
torch.save(model.state_dict(), f'../../../pretrained_gcn/gcn_an_hy_{rand_seed}.pth')
