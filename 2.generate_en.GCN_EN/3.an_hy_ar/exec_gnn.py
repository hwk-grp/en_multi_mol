...
n_epochs = 150
init_lr = 0.001
l2_coeff = 1.61050628437249E-06
n_fp = 256
n_radius = 4
dims = [256, 32, 96, 128, 1]
n_layers = [2, 4, 3]
...
df_en.to_excel('../../feats/gcn_en/3.an_hy_ar/en_an_hy_ar_' + str(en_dim) + '_' + str(rand_seed) + '.xlsx', index=False)
print(f'AN_HY_AR length: {str(en_dim)} Seed: {str(rand_seed)} done')
