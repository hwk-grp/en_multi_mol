...
import torch
import utils.ml
import utils.chem_en_an_hy_ar as chem
...
opt = '../../../feats/gcn_en/en_an_hy_ar_2_2024.xlsx' # from 2021 2030
...
df.to_excel(f'preds/gcn_{dataset_name}_{rand_seed}_h_type6_{en_dim}.xlsx', index=False)

# Save the GCN model
torch.save(model.state_dict(), f'../../../pretrained_gcn/gcn_an_hy_ar_{rand_seed}.pth')
