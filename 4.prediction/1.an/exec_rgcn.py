...
import torch
import utils.ml
import utils.chem_en_an_rgcn as chem
...
opt = f'../../feats/gcn_en/1.an/en_an_{en_dim}_2024.xlsx'
n_rel = 3 # number of clusters to classify chemical bonds in dataset
...
df.to_excel(f'preds/rgcn_{dataset_name}_{rand_seed}_an_{en_dim}_{n_rel}.xlsx', index=False)
