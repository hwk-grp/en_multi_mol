...
import torch
import utils.ml
import utils.chem_en_an_hy_rgcn as chem
...
n_rel = 8 # number of clusters to classify chemical bonds in dataset
...
df.to_excel(f'preds/rgcn_{dataset_name}_{rand_seed}_an_hy_{en_dim}_{n_rel}.xlsx', index=False)
